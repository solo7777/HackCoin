...
import "@openzeppelin/contracts/token/ERC20/extensions/ERC20Permit.sol"; // 🔸 Додано
import "@openzeppelin/contracts/access/Ownable.sol";

contract HackCoin is ERC20Votes, ERC20Permit, Ownable {
    uint256 public constant MAX_SUPPLY = 4_000_000 * 10 ** 18;

    constructor()
        ERC20("HackCoin", "HKC")
        ERC20Permit("HackCoin") // 🔸 Цей конструктор тепер коректний
    {
